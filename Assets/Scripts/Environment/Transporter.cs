...
namespace br.com.bonus630.thefrog.Environment
{
    public class Transporter : MonoBehaviour
    {
        ...
        void Update()
        {
            if (going)
            {
               ...
               // transform.Translate(direction * Time.deltaTime * speed);
                ...
                //    }
                //}
                Debug.Log("Distance:" + (Vector3.Distance(transform.position, worldDestination)));
        ...
        float CalculateSpeed(float distanceToTarget)
        {
            ...
            // Parte que reduz a velocidade gradualmente
            float progress = distanceToTarget / startSlowingDistance; // entre 0 e 1
            float multiplier = Mathf.Pow(0.5f, 1f - progress); // curva suave
